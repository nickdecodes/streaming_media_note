...
[FFmpeg 开发库下载地址](https://github.com/BtbN/FFmpeg-Builds/releases)（自行选定版本号，-shared 为开发库）：

![图片](https://mmbiz.qpic.cn/mmbiz_png/GjBg4Rhq9j1vCMWXSuWffZs4icLuPiclYAKKlTXMlzam4BibdCJheyibTKhYDZYaeNrHKic71SicqMdbv1AQbzwt5Ijw/640?wx_fmt=png&wxfrom=5&wx_lazy=1&wx_co=1)



[SDL 开发库下载地址](https://www.libsdl.org/download-2.0.php)（选择Development Libraries）：

![图片](https://mmbiz.qpic.cn/mmbiz_png/GjBg4Rhq9j1vCMWXSuWffZs4icLuPiclYAMXNNpm9YjGeCVf2dMCo9LGAouIj05rIibESLu5ETBGCia9vF1Ng52ficw/640?wx_fmt=png&wxfrom=5&wx_lazy=1&wx_co=1)
...
![图片](https://mmbiz.qpic.cn/mmbiz_png/GjBg4Rhq9j1vCMWXSuWffZs4icLuPiclYAia1aTBMWRMicrW1j6aK2dDLwPQUun23sl3czcol2oI1UmIuEYxMAGKkg/640?wx_fmt=png&wxfrom=5&wx_lazy=1&wx_co=1)
...
![图片](https://mmbiz.qpic.cn/mmbiz_png/GjBg4Rhq9j1vCMWXSuWffZs4icLuPiclYAQDtB5KHpOKRvBVrKsCic5efDcV8iaR9X2IuvZ1v7pqNNLlFuia108TmPg/640?wx_fmt=png&wxfrom=5&wx_lazy=1&wx_co=1)
	...
	p_ffmpeg_param->pFormatCtx = avformat_alloc_context();
 	...
 	if (avformat_open_input(&(p_ffmpeg_param->pFormatCtx), filePath, NULL, NULL) != 0) {
      ...
      p_ffmpeg_param->pSwsCtx = sws_getContext(p_ffmpeg_param->pCodecCtx->width,
                                               ...
                                               p_ffmpeg_param->pCodecCtx->width, 
                                               p_ffmpeg_param->pCodecCtx->height,
                                               AV_PIX_FMT_YUV420P,  
