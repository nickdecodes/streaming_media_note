...
```bash
ffplay --help
ffplay -window_title "test" file # 播放本地流
ffplay http://ivi.bupt.deu.cn/hls/cctv6hd.m3u8 # 播放网络流
# 示例
ffplay -x 1024 -y 768 -an file
ffplay -ss 10 -t 5 -fs -loop 2 file
ffplay -f file -video_size 640x360 file
```
